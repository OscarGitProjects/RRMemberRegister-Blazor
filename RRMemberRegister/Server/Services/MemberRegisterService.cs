...
namespace MemberRegister.Services
{
    ...
    public class MemberRegisterService : IMemberRegisterService
    {
        ...
        /// Konstruktor
        /// </summary>
        /// <param name="repository">Reference till repository lagret</param>
        ...
        /// <returns>Objekt med medlemmens information uppdaterad med det id som medlemen fick i repository. Om det inte gick att spara returneras null</returns>
        ...
        /// </summary>
        /// <returns>Om raderingen gick bra returneras antalet raderade medlemmar. Annars returneras ett negativt tal</returns>
        ...
        /// <returns>Sökt medlem eller null</returns>
        /// <exception cref = "System.ArgumentException" > Om id är ogiltigt dvs id <= 0</exception>
        ...
        public List<Member> GetMembers()
        {
            ...
            {
                foreach (Member mem in lsMembers)
                    mem.Skapatdatumasstring = mem.Skapatdatum.ToShortDateString();
            }
